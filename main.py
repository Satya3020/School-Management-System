...
def login():
    ...
    m=Label(root, text="incorrect username or password",font=('Arial', 15, 'bold'),fg='red')
    name=e1l.get()
    password=e2l.get()
    my=db.cursor()
    ...
    for i in my:
       if str(i[1])==name and str(i[2])==password:
          show(home)
          cls_1=Label(home,text='USER: ',
                      font=('Arial', 15, 'bold'),fg='#145862',bg='white')
          cls_1.place(x=20,y=10)
          cls_2=Label(home,text='class : ',font=('Arial', 15, 'bold')
                      ,fg='#145862',bg='white')
          cls_2.place(x=650,y=10)
          teacher=Label(home,text=name,font=('Arial', 15, 'bold'),fg='green',bg='white')
          teacher.place(x=200,y=10)
          cls_3=Label(home,text='Xll',font=('Arial', 15, 'bold'),fg='green',bg='white')
...
adr=Label(regf,text="School Management System",bg='white'
          ,font=('Arial', 25, 'bold'),fg='#d76737')
adr.pack()
l1r=Label(regf,text="username",font=('Arial', 25, 'bold'),fg='orange',bg='white')
l1r.place(x=240,y=120)
l2r=Label(regf,text="password",font=('Arial', 25, 'bold'),fg='orange',bg='white')
l2r.place(x=240,y=210)
e1r=StringVar()
namesr=ttk.Entry(regf,textvariable=e1r,font = ('Arial', 22, 'bold'))
namesr.focus_force()
namesr.place(x=240,y=175)
e2r=StringVar()
pwr=ttk.Entry(regf,textvariable=e2r,show='*',font = ('Arial', 22, 'bold'))
pwr.focus_force()
...
adl=Label(loginf,text="School management system",bg='white'
          ,font=('Arial', 25, 'bold'),fg='#d76737')
adl.pack()
l1l=Label(loginf,text="username",font=('Arial', 25, 'bold'),fg='orange',bg='white')
l1l.place(x=240,y=120)
l2l=Label(loginf,text="password",font=('Arial', 25, 'bold'),fg='orange',bg='white')
l2l.place(x=240,y=210)
e1l=StringVar()
namesl=ttk.Entry(loginf,textvariable=e1l,font = ('Arial', 22, 'bold'))
namesl.place(x=240,y=175)
e2l=StringVar()
pwl=ttk.Entry(loginf,textvariable=e2l,show='*',font = ('Arial', 22, 'bold'))
...
def insert():
  ...
  if name=="''" or admission=="''":
      ...
      m4=Label(root, text="successfully added to database",font=('Arial', 15, 'bold'),fg='green')
      root.after(100, lambda:m4.pack())
      root.after(1500, lambda:m4.pack_forget())

add_name1=Label(add,text='name',bg='white',fg='#145862',font=('Arial', 15, 'bold'))
add_name1.place(x=50,y=100)
nm1=StringVar()
nma=ttk.Entry(add,textvariable=nm1 ,font = ('Arial', 10, 'bold'))
nma.place(x=50,y=130)
admis1=Label(add,text='admission no.',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
admis1.place(x=50,y=200)

p1=StringVar()
poia=ttk.Entry(add,textvariable=p1 ,font = ('Arial', 10, 'bold'))
poia.place(x=50,y=230)

percent1=Label(add,text='percent',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
percent1.place(x=350,y=220)
per1=StringVar()
pera=ttk.Entry(add,textvariable=per1 ,font = ('Arial', 10, 'bold'))
pera.place(x=350,y=250)

dob_1=Label(add,text='DOB',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
dob_1.place(x=350,y=100)
dob1=StringVar()
doba=ttk.Entry(add,textvariable=dob1 ,font = ('Arial', 10, 'bold'))
doba.place(x=350,y=130)

gender1=Label(add,text='Gender',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
gender1.place(x=350,y=160)
gen1=StringVar()
gena=ttk.Entry(add,textvariable=gen1 ,font = ('Arial', 10, 'bold'))
...
def delete():
    ...
    if dictc['text']=='':  #cheak if name deleted
        ...
        div_doba.delete(0,END)
        div_gena.delete(0,END)
        m=Label(root, text="Successfully removed from database",font=('Arial', 15, 'bold'),fg='green')
...
def update():
  ...
  db.commit()
  m3=Label(root, text="successfully updated",font=('Arial', 15, 'bold'),fg='green')
...
######
up_name=Label(div,text='NAME',bg='white',fg='#145862',font=('Arial', 15, 'bold'))
up_name.place(x=50,y=100)
div_nm1=StringVar()
div_nma=ttk.Entry(div,textvariable=div_nm1 ,font = ('Arial', 10, 'bold'))
div_nma.place(x=50,y=130)

admis2=Label(div,text='ADMISSION NO.',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
admis2.place(x=50,y=200)

div_p1=StringVar()
div_poia=ttk.Entry(div,textvariable=div_p1 ,font = ('Arial', 10, 'bold'))
div_poia.place(x=50,y=230)

percent2=Label(div,text='percent',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
percent2.place(x=350,y=220)
div_per1=StringVar()
div_pera=ttk.Entry(div,textvariable=div_per1 ,font = ('Arial', 10, 'bold'))
div_pera.place(x=350,y=250)

dob_2=Label(div,text='DOB',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
dob_2.place(x=350,y=100)
div_dob1=StringVar()
div_doba=ttk.Entry(div,textvariable=div_dob1 ,font = ('Arial', 10, 'bold'))
div_doba.place(x=350,y=130)

gender2=Label(div,text='Gender',fg='#145862',bg='white',font = ('Arial', 15, 'bold'))
gender2.place(x=350,y=160)
div_gen1=StringVar()
div_gena=ttk.Entry(div,textvariable=div_gen1 ,font = ('Arial', 10, 'bold'))
div_gena.place(x=350,y=190)
############################################################################
bg_color='white'

team=Label(intro,text='Team member',font = ('Arial', 25, 'bold'),bg='white',fg='#ff0303')
team.pack()

n1=Label(intro,text='',font = ('Arial', 15, 'bold'),bg='white',fg='#0061b0')
n1.place(x=10,y=100)
n2=Label(intro,text='',font = ('Arial', 15, 'bold'),bg='white',fg='#0061b0')
n2.place(x=10,y=150)
n3=Label(intro,text='',font = ('Arial', 15, 'bold'),bg='white',fg='#0061b0')
n3.place(x=10,y=200)
n4=Label(intro,text='',font = ('Arial', 15, 'bold'),bg='white',fg='red')
n4.place(x=10,y=250)

n5=Label(intro,text="",font = ('Arial', 15, 'bold'),bg='white',fg='#0061b0')
n5.place(x=10,y=300)
